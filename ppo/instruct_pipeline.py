...
class InstructionTextGenerationPipeline(Pipeline):
    ...
    def _forward(self, model_inputs, **generate_kwargs):
        ...
        generated_sequence = self.model.generate(
            input_ids=input_ids.to(self.model.pretrained_model.device),
            attention_mask=attention_mask.to(self.model.pretrained_model.device) if attention_mask is not None else None,
